...
async function main(data_in) {
  ...
  //~~~~~~~~~~~1
  await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates compile -i hashexample.code');
  await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates compute-witness -a 0 0 0 ' + data_in_int);
  ...
  await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates compile -i hashexample2.code');
  console.log("done example2");
  await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates setup');
  console.log("done setup");
  await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates export-verifier');
...
async function createProof(_data_in, _out0, _out1) {
  ...
  try {
    ...
    await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates compute-witness -a 0 0 0 '
      + data_in_int + " " + _out0 + " " + _out1);
    console.log("done compute witness with 6 paramater");

    
    await sh_zokrates('/home/daidinh/.zokrates/bin/zokrates generate-proof');
